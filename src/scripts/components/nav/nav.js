                    ...
                    <div class="container flex flex-wrap justify-between items-center mx-auto">
                        ...
                        <div class="hidden overflow-hidden items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu">
                            ...
                            <ul class="flex flex-col w-full mt-4 md:flex-row md:space-x-8 md:mt-0 ">
                                ...
                                <li class="hover:border-b-2 hover:translate-x-1 hover:border-gray-600 hpy:border-none">
                                    <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:text-blue-600 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0">Citas</a>
                                </li>
                    ...
                    <div class="container flex flex-wrap justify-between items-center mx-auto">
                        ...
                        <div class="hidden overflow-hidden items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu">
                            <ul class="flex flex-col w-full mt-4 md:flex-row md:space-x-8 md:mt-0 ">
                                ...
                                <li class="hover:border-b-2 hover:translate-x-1 hover:border-gray-600 hpy:border-none">
                                    <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:text-blue-600 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0">Mis pacientes</a>
                                </li>
                    ...
                    <div class="container flex flex-wrap justify-between items-center mx-auto">
                        ...
                        <div class="hidden overflow-hidden items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu">
                            ...
                            <ul class="flex flex-col w-full mt-4 md:flex-row md:space-x-8 md:mt-0 ">
                                ...
                                <li class="hover:border-b-2 hover:translate-x-1 hover:border-gray-600 hpy:border-none">
                                    <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:text-blue-600 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 ">Pacientes</a>
                                </li>
