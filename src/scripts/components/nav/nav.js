                    ...
                    <div class="container flex flex-wrap justify-between items-center mx-auto">
                        ...
                        <div class="hidden overflow-hidden items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu">
                            ...
                            <ul class="flex flex-col w-full mt-4 md:flex-row md:space-x-8 md:mt-0 ">
                                ...
                                <li class="hover:border-b-2 hover:translate-x-1 hover:border-gray-600 hpy:border-none">
                                    <a href="/src/view/admin/assign/ListAssign.html" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 hover:text-blue-600 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 ">Asignaciones</a>
                                </li>
                                ...
                                <li>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu z-50 absolute hidden block pt-1 hpy:w-full">
                                            <li>
                                                <a href="/src/view/patient/history.html" class="block text-blue-700 border-b bg-white border-gray-100 hover:text-blue-600 py-4 px-4 hover:bg-gray-50 ">Mi historial</a>
                                            </li>
                                            <li>
                                                <a href="/src/view/chat/chat.html" class="block text-blue-700 border-b bg-white border-gray-100 hover:text-blue-600 py-4 px-4 hover:bg-gray-50 ">Chat con administrador</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="/src/view/patient/ListTreatments.html" class="block text-blue-700 border-b bg-white border-gray-100 hover:text-blue-600 py-4 px-4 hover:bg-gray-50">Mis recetas</a>
                                            </li>
                                            <li>
                    ...
                    <div class="container flex flex-wrap justify-between items-center mx-auto">
                        ...
                        <div class="hidden items-center w-full md:flex md:w-auto md:order-1 " id="mobile-menu-4">
                            ...
                            <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0  ">
                                ...
                                <li class="hover:border-b-2 hover:translate-x-1 hover:border-gray-600 hpy:border-none">
                                    <a href="/src/view/index.html#nosotros" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:text-blue-600 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0">Nosotros</a>
                                </li>
                                
                                <li class="hover:border-b-2 hover:translate-x-1 hover:border-gray-600 hpy:border-none">
                                    <a href="/src/view/contact/contact.html" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:text-blue-600 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0">Contacto</a>
                                </li>
                                <li class="hover:border-b-2 hover:translate-x-1 hover:border-gray-600 hpy:border-none">
